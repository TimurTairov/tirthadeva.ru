      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch lg:grid-cols-3 lg:gap-8 ">
        <div className="divide-y dark:divide-gray-200 divide-gray-400 mx-4 sm:mx-4 md:mx-2 lg:mx-0 rounded-2xl bg-gray-50 dark:bg-transparent border dark:border-slate-600 shadow-sm shadow-gray-400 dark:shadow-gray-600">
          <div className="p-5 md:p-3 lg:p-6 lg:px-8">
            ...
            <a
              className="mt-4 block rounded border border-indigo-600 bg-indigo-600 dark:border-emerald-400 dark:bg-emerald-400  px-12 py-3 text-center text-sm font-medium text-white dark:text-gray-50 hover:bg-transparent hover:text-indigo-600 dark:hover:text-emerald-400 dark:hover:bg-transparent focus:outline-none focus:ring active:text-indigo-500 dark:active:text-emerald-500 sm:mt-6"
