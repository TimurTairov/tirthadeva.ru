        ...
        <div>
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <MyAccordion title="Список проведенных мероприятий" id="myEvents" className="bg-gray-50 dark:bg-slate-700 shadow-md p-2 rounded-md">
              ...
              <p className="textMP">• №15 Проводил три практики (хатха, крийя-кундалини и раджа йога) на дне йоги в ДЦ ШактиМа. 21.06.2026;</p>
              <p className="textMP">• №16 Медитативный ретрит в ДЦ ШактиМа. 29.06.2026;</p>
            </MyAccordion>
