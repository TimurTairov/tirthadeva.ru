...
const page = () => {
  ...
  return (
    <div className='max-w-screen-xl min-h-screen mx-auto flex flex-col items-start justify-between text-xl'>
      ...
      <h1 className="text-4xl font-semibold text-center w-full">Образование</h1>
      ...
      <p className="flex items-center gap-1">
        <BsDot /> Хатха йога, кундалини йога, медитация, созерцание
      </p>
      <p className="flex items-center gap-1">
        <BsDot />
        Джняна и лайя йога
      ...
      <p className="flex items-center gap-1">
        <BsDot />
        Ритуальная практика (Бхаджан мандала, сутра, хома, пуджа, абхишека)
      </p>
      <p className="flex items-center gap-1">
        <BsDot />
        Философия Адвайта Веданты и йоги сиддхов
      </p>
      <p className="flex items-center gap-1">
        <BsDot />
        Ритритная практика в Ашраме
      </p>
      ...
      <div className="flex items-center gap-1">
        <BsDot />
        <p>
          2015 г. - обучение йоги у <a href='http://yogagu.ru/' target='_blank' rel="noreferrer">Виктора Кожаринова </a> (ученик Сатьянанда Сарасвати, Бихарская школа йоги). Неформально в поездках по Индии и в Москве.
        </p>
      </div>
      <p className="flex items-center gap-1">  <BsDot />2018 г. - обучение крийя йоге в традициии йоги Рамайяхи. Ведущий  Святослав Дубянский.</p>
      <p className="flex items-center gap-1">  <BsDot />2019 г. - обучение Кундалини йоге с Учителем из Варанаси (Индия) Satayanand Giri (Lali Baba).</p>
