        ...
        <div>
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <MyAccordion title="Список ретритов и семинаров в традиции Пратьякша Адвайта сиддхов" id="advaytaSiddhov" className="bg-gray-50 dark:bg-slate-700 shadow-md p-2 rounded-md">
              ...
              <p className="textMP">• №16 Двухдневный семинар: Бхаджан Мандала мистерия звука с Нитьяшри Гири (октябрь 2024);</p>
              <p className="textMP">• №17 Трехдневный ретрит по кундалини йоге (январь 2025);</p>
              <p className="textMP">• №18 Трехдневный ретрит по тонкой концентрации (февраль 2025);</p>
              <p className="textMP">• №19 Семидневный ретрит по базовым практикам (май 2025);</p>
              <p className="textMP">• №20 Недельный семинар с Гуру в Казахстане (июль 2025);</p>
              <p className="textMP">• №21 Семидневный ретрит по изучению учения (ноябрь 2025);</p>
              <p className="textMP">• №22 Двухдневный семинар: 20 крий кундалини йоги и йога иллюзорного тела со свамини Ананда Лила Гири (май 2026);</p>
              <p className="textMP">• №23 Семинар по крийя кундалини йоге №1 с монахом Раманатха Гири (май 2026);</p>
              <p className="textMP">• №24 Семинар по крийя кундалини йоге №2 с монахом Раманатха Гири (июнь 2026);</p>
            </MyAccordion>
            ...
            <MyAccordion title="Список проведенных мероприятий" id="myEvents" className="bg-gray-50 dark:bg-slate-700 shadow-md p-2 rounded-md">
              ...
              <p className="textMP">• №12 Медитативный ретрит. ДЦ ШактиМа 24.05.2026. </p>
              <p className="textMP">• №13 Интенсив по динамической йоге. ДЦ ШактиМа 31.05.2026.</p>
              <p className="textMP">• №14 Проводил практику йоги на главной сцене фестиваля День Йоги на Воробьевых горах. 21.06.2026.</p>
              <p className="textMP">• №14 Проводил три практики (хатха, крийя-кундалини и раджа йога) на дне йоги в ДЦ ШактиМа. 21.06.2026.</p>
              <p className="textMP">• №15 Медитативный ретрит в ДЦ ШактиМа. 29.06.2026.</p>
            </MyAccordion>
