        ...
        <div>
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <MyAccordion title="Список ретритов и семинаров в традиции Пратьякша Адвайта сиддхов" id="advaytaSiddhov" className="bg-gray-50 dark:bg-slate-700 shadow-md p-2 rounded-md">
              ...
              <p className="textMP">• №22 Двухдневный семинар: 20 крий кундалини йоги и йога иллюзорного тела со свамини Ананда Лила Гири (май 2025);</p>
              <p className="textMP">• №23 Семинар по крийя кундалини йоге №1 с монахом Раманатха Гири (май 2025);</p>
            </MyAccordion>
