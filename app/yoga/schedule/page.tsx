...
const page = () => {
  return (
    <div className='main-container font-light'>
      ...
      <h5 className='mt-5 mb-1'>1. <a href='https://fitness-cccp.ru/clubs/mihajlovskij/' target='_blank' rel='noreferrer' >Фитнес клуб СССР Волгоградский проспект </a></h5>
      ...
      <h5 className='mt-5 mb-1'>2. <a href='https://ivanovskoe.mangofitness.ru/' target='_blank' rel='noreferrer'>Фитнес клуб Манго</a></h5>
      <p className="flex items-center">
        <FaSun className='me-2' color='orange' />
        Понедельник 21:00 Хатха йога (90 минут)
      </p>

      <h5 className='mt-5 mb-1'>3. <a href='https://fitnessavenue.ru/' target='_blank' rel='noreferrer'>Фитнес Авеню</a></h5>
      <p className="flex items-center">
        <FaSun className='me-2' color='orange' />
      ...
      <h5 className='mt-5 mb-1'>4. <a href='http://prostozvezda.ru/' target='_blank' rel='noreferrer'>Детский центр &quot;Звезда&quot;</a></h5>
      <p className="flex items-center">
        <FaSun className='me-2' color='orange' />
      ...
      <h5 className='mt-5 mb-1'>5. <a href='https://ddsport.fitness/' target='_blank' rel='noreferrer'>Фитнес клуб DD Sport</a></h5>
      <p className="flex items-center">
        <FaSun className='me-2' color='orange' />
