...
const page = () => {
  return (
    <div className='main-container'>
      ...
      <h2 className='text-3xl mt-10 mb-2'>Отзыв Натальи</h2>
      <h6> <b>Как я пришла к йоге!</b> <br />
        ...
        <br /><b>Что достигнуто за 3 года.</b> <br />
      ...
      <h2 className='text-3xl mt-10 mb-2'>Отзыв Ирины</h2>
      ...
      <h2 className='text-3xl mt-10 mb-2'>Отзыв Елены</h2>
      <h6>
      ...
      <h2 className='text-3xl mt-10 mb-2'>Отзыв Марии</h2>
      <h6 className='mb-10'>
