...
const page = () => {
  ...
  return (
    <div className='main-container textMP'>
      ...
      <MyAccordion title={'Отзыв на ретрит: Мария (Манджушри)'} id='08' >
        <div className='px-2 text-base'>
          <p>
            Огромная благодарность @tirthadeva за вчерашний ритрит! Было очень полезно, благостно 🙏🏻💗 особенно ценно, что Тиртхадева многое объясняет через свой личный наработанный опыт, что особенно важно в практике.
          </p>

        </div>
      </MyAccordion>

      <MyAccordion title={'Отзыв на ретрит: Константин'} id='06' >
        <div className='px-2 text-base'>
          <p>
            Спасибо Тиртхадеву за воскресный ретрит по медитации.
            Кроме медитации мы практиковали асаны, немного дыхательных упражнений и созерцание при ходьбе.
            Гармоничное сочетание и чередование практик, подробные объяснения ведущего позволили соприкоснуться с более глубоким самоосознаванием.
            Сам формат однодневного ретрита очень подходит для работающего человека. Хорошая возможность погрузиться в практику.
            После ретрита осталось вдохновение, хорошее самочувствие. Знакомые даже сделали комплимент, что меня словно подменили.
            И конечно собираюсь участвовать в следующем подобном мероприятии🙏
          </p>
      ...
      <MyAccordion title={'Отзыв на ретрит: Ольга'} id='07' >
        <div className='px-2 text-base'>
          <p>
            Я благодарю Тимура и всех собравшихся за ретрит, за комфортную атмосферу, за глубокое погружение, за подробные пояснения и замечательные практики. Ухожу с состоянием покоя, умиротворения и радости. Спасибо огромное за эту удивительную возможность погрузиться в ретрит, не планируя долго поездку куда-то далеко в особое место, а  встроить его в обычную жизнь.
          </p>
